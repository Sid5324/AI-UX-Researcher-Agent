...
from backend.src.core.config import get_settings, constants
from backend.src.core.ai_manager import AIManager
from backend.src.core.goal_parser import GoalParser, parse_goal
from backend.src.core.react_engine import ReActEngine, ReActState
...
class TestGoalParser:
    ...
    async def test_quick_estimate(self, goal_parser):
        ...
        with patch.object(goal_parser.ai_manager, 'generate_json') as mock_gen:
            ...
            from backend.src.core.goal_parser import quick_estimate
...
class TestReActEngine:
    ...
    async def test_state_transitions(self, session, test_goal, test_user):
        ...
        from backend.src.database.models import AgentState
